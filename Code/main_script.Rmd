...
soil
```{r}
NEON_SOIL_CPER_1 <-read_csv("../Data/Processed/NEON_heatflux-soil/NEON_SOIL_CPER_1.csv")

NEON_SOIL_CPER_2 <-read_csv("../Data/Processed/CPER/NEON_SOIL_CPER_2.csv")

NEON_SOIL_CPER_3 <-read_csv("../Data/Processed/CPER/NEON_SOIL_CPER_1.csv")
...
```{r}
NEON_SOIL_RMNP_1 <-read_csv("NEON.D10.RMNP.DP1.00040.001.2017-09.basic.20230127T120753Z.RELEASE-2023/NEON_SOIL_RMNP_1.csv")
