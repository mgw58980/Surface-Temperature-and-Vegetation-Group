...
```
The figure is a barplot comparing CPER and RMNP temperature difference.  Sites are shown along the x-axis and the average temperature difference is on the y-axis.  There is a clear and large difference between the two with short error bars.
