...
```
#Figure 2 shows the mean percent cover found within the sites RMNP and CPER. The mean cover was recorded includes the max crown diameter of the vegetation found within the sites  


I hope yall can see it 
...
```
Figure Caption: The line plot above describes the relationship between the temperature difference of air and soul between two sites during September 2017. The red lines are RMNP. The blue lines CPER.
...
>>>>>>> 470f0d72f2fbd1cd066da0e9d0d0afe95f3755e9
...
neon_soil_total <- bind_rows(NEON_SOIL_RMNP_1, NEON_SOIL_RMNP_2, NEON_SOIL_RMNP_3, NEON_SOIL_CPER_1, NEON_SOIL_CPER_2, NEON_SOIL_CPER_3) %>% 
  mutate(day = floor_date(startDateTime, unit = "day")) %>%
