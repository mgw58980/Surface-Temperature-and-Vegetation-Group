...
total_veg%>%
  ...
  drop_na() %>%
  ggplot(aes(x=siteID, y=mean_mean_cover, fill= siteID))+ 
  geom_col()+ 
  geom_errorbar(aes(ymin = mean_mean_cover - standard_error, ymax = mean_mean_cover + standard_error), width = .8)
...
neon_difference %>%
  ...
  ggplot(aes(x=siteID , y=mean_temp_difference))+
  geom_col(aes(color = siteID))+
  geom_errorbar(aes(ymin = mean_temp_difference - standard_error, ymax = mean_temp_difference + standard_error), width = .8)
```
